...
export { default as RightSidebar } from './navbar/RightSidebar';
export { default as ClassNavbar } from './navbar/ClassNavbar';

export { default as Home } from "./pages/Home";
export { default as Calender } from "./pages/Calender";
export { default as ArchivedClasses } from "./pages/ArchivedClasses";
